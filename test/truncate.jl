...
function verify_and_test(d::UnivariateDistribution, dct::Dict, n_tsamples::Int)
    ...
    for pt in pts
        ...
        if !isa(d, DistributionsGPU.Truncated{DistributionsGPU.StudentizedRange{Float64},Distributions.Continuous})
        ...
        if !(typeof(d) in [DistributionsGPU.Truncated{Distributions.NoncentralChisq{Float64},DistributionsGPU.Continuous, Float64},
                           DistributionsGPU.Truncated{Distributions.NoncentralF{Float64},DistributionsGPU.Continuous, Float64},
                           DistributionsGPU.Truncated{Distributions.NoncentralT{Float64},DistributionsGPU.Continuous, Float64},
                           DistributionsGPU.Truncated{Distributions.StudentizedRange{Float64},DistributionsGPU.Continuous, Float64}])
